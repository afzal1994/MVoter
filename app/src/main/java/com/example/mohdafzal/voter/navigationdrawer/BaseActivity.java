...
import com.example.mohdafzal.voter.IContants;
import com.example.mohdafzal.voter.LoginActivity;
import com.example.mohdafzal.voter.MainPage;
import com.example.mohdafzal.voter.OutOfTownActivity;
import com.example.mohdafzal.voter.PendinDoneVotersList;
import com.example.mohdafzal.voter.R;
import com.example.mohdafzal.voter.UpvibhagActivity;
import com.example.mohdafzal.voter.Voterlist;
import com.example.mohdafzal.voter.VotingDayActivity;
            ...
            switch (position) {
                ...
                case 1:
                    ...
                    if (!this.getClass().getSimpleName().matches("UpvibhagActivity")) {
                        adapter.notifyDataSetChanged();
                        startActivity(new Intent(this, UpvibhagActivity.class));
                    }
                    break;
                case 2:
                    navCount = 2;
                ...
                case 4:
                    ...
                    if (!this.getClass().getSimpleName().matches("VotingDayActivity")) {
                        if (user_id2 != 6) {
                            ...
                            startActivity(new Intent(this, PendinDoneVotersList.class));
            ...
            switch (position) {
                ...
                case 2:
                    ...
                    if (!this.getClass().getSimpleName().matches("AddNewVoter")) {
                        Intent intent = new Intent(this, AddNewVoter.class);
