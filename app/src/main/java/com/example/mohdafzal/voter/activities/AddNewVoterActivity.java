...
public class AddNewVoterActivity extends BaseActivityNavigation implements View.OnClickListener, TextView.OnEditorActionListener {
    ...
    private List<PostsHirarchyModel> yourList;
        ...
        switch (v.getId()) {
            ...
            case R.id.datepicker:
                new SpinnerDatePickerDialogBuilder()
                    .context(AddNewVoterActivity.this)
    ...
    private void sendreq() {
        ...
        if (fname.getText().toString().matches("")) {
            ...
            if (!NetworkUtil.isNetworkAvailable(AddNewVoterActivity.this)) {
/*
...
*/
                            progressDialog.hide();
                            Toast.makeText(AddNewVoterActivity.this, jsonArray.getJSONObject(0).getString("msg"), Toast.LENGTH_SHORT).show();

                            Intent intent = new Intent(AddNewVoterActivity.this, Voterlist.class);
                            finish();
                            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                                startActivity(intent, ActivityOptions
                                    .makeSceneTransitionAnimation(AddNewVoterActivity.this).toBundle());
                            } else {
                                startActivity(intent);
                            }
                                /*} else {
                                    progressDialog.hide();
                                    Toast.makeText(AddNewVoterActivity.this, "please check internet settings", Toast.LENGTH_SHORT).show();
                                }*/
                    ...
                    public void onErrorResponse(VolleyError error) {
                        progressDialog.hide();
                        Toast.makeText(AddNewVoterActivity.this, error.toString(), Toast.LENGTH_SHORT).show();
                    }
                });
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ArrayAdapter<String> dataAdapter = new ArrayAdapter<String>(AddNewVoterActivity.this,
