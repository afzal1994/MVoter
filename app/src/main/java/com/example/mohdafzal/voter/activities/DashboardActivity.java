...
public class DashboardActivity extends BaseActivityNavigation implements View.OnClickListener {
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.upvibhag:
                Intent intent = new Intent(this, PostsHirarchyActivity.class);
            ...
            case R.id.outoftownlist:
                intent = new Intent(DashboardActivity.this, OutOfTownActivity.class);
                startActivity(intent);
                break;

            case R.id.myWard:
                if (user_option == 6) {
                    Intent intent3 = new Intent(this, AddNewVoterActivity.class);
            ...
            case R.id.votingday:
                ...
                Intent intent4 = new Intent(this, user_id2 == 6 ? PendingDoneVotersList.class : VotingDayActivity.class);
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
