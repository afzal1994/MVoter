...
public class UpvibhagOnclick extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_upvibhag_onclick);
                ...
                if (extras.getString("phone_number")!=null) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
                        startActivity(intent, ActivityOptions
                            .makeSceneTransitionAnimation(UpvibhagOnclick.this).toBundle());
                    } else {
                        startActivity(intent);
                    }
                }else {
                    Toast.makeText(UpvibhagOnclick.this, "No Phone Number Provided", Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    UpVibhagOnclickAdapter areAdapter = new UpVibhagOnclickAdapter(UpvibhagOnclick.this, yourList);
                    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.upvibhagRecycler);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(UpvibhagOnclick.this);
