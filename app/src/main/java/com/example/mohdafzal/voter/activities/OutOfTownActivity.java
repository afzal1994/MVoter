...
import com.example.mohdafzal.voter.adapter.VoterAdapter;
...
public class OutOfTownActivity extends BaseActivityNavigation {

    private String[] navMenuTitles;
    private TypedArray navMenuIcons;
    private RecyclerView upVibhagRecycler;
    private Button upvibhagButton;
    private TextView outOfTownText;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        outOfTownText = (TextView) findViewById(R.id.text);
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    ((TextView) findViewById(R.id.text)).setText("Out of town :" + yourList.size());
    ...
    private void getCount() {
        ...
        SharedPreferences sharedPreference2 = getSharedPreferences("userid", MODE_PRIVATE);
        int user_id2 = sharedPreference2.getInt("user_id", 1);
        String url2 = "http://electionapp.uxservices.in/Web_Services/Out_Of_Voter_Count.asmx/outofutown?user_id=" + user_id2;
        System.out.println("thisurl" + url2);
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, new Response.Listener<String>() {
            @Override
            public void onResponse(String response) {
                ...
                try {
                    ...
                    upvibhagName.setText("Upvibhag : patilwadi");
                    outOfTownText.setText("Out of town :" + jsonObject.getJSONArray("data").getJSONObject(0).getString("Out Of Voters Count"));
