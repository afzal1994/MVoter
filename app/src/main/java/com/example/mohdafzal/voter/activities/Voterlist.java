...
import com.example.mohdafzal.voter.adapter.VotersPostHirarchyAdapter;
...
public class Voterlist extends BaseActivityNavigation {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        button.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(Voterlist.this, AddNewVoterActivity.class);
        ...
        StringRequest stringRequest2 = new StringRequest(Request.Method.GET, url2, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    SharedPreferences sharedPreferences = getSharedPreferences("userid", MODE_PRIVATE);
                    int id = sharedPreferences.getInt("user_id", 1);
                    VotersPostHirarchyAdapter areAdapter = new VotersPostHirarchyAdapter(Voterlist.this, yourList);
                    RecyclerView recyclerView = (RecyclerView) findViewById(R.id.workerrec);
                    RecyclerView.LayoutManager layoutManager = new LinearLayoutManager(Voterlist.this);
                    recyclerView.setLayoutManager(layoutManager);
                    recyclerView.setAdapter(areAdapter);
